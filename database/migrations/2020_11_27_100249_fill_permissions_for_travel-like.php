...
class FillPermissionsForTravelLike extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTravelLike constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.travel-like',
            'admin.travel-like.index',
            'admin.travel-like.create',
            'admin.travel-like.show',
            'admin.travel-like.edit',
            'admin.travel-like.delete',
            'admin.travel-like.bulk-delete',
        ]);
