...
class FillPermissionsForArticleType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForArticleType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.article-type',
            'admin.article-type.index',
            'admin.article-type.create',
            'admin.article-type.show',
            'admin.article-type.edit',
            'admin.article-type.delete',
            'admin.article-type.bulk-delete',
        ]);
