...
class FillPermissionsForCompanion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCompanion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.companion',
            'admin.companion.index',
            'admin.companion.create',
            'admin.companion.show',
            'admin.companion.edit',
            'admin.companion.delete',
            'admin.companion.bulk-delete',
        ]);
