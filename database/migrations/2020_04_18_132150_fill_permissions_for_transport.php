...
class FillPermissionsForTransport extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTransport constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.transport.create',
            'admin.transport.show',
            'admin.transport.edit',
            'admin.transport.delete',
            'admin.transport.bulk-delete',
        ]);
