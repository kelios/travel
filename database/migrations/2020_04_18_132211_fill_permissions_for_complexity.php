...
class FillPermissionsForComplexity extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForComplexity constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.complexity',
            'admin.complexity.index',
            'admin.complexity.create',
            'admin.complexity.show',
            'admin.complexity.edit',
            'admin.complexity.delete',
            'admin.complexity.bulk-delete',
        ]);
