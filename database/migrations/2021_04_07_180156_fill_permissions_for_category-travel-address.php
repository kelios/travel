...
class FillPermissionsForCategoryTravelAddress extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategoryTravelAddress constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.category-travel-address',
            'admin.category-travel-address.index',
            'admin.category-travel-address.create',
            'admin.category-travel-address.show',
            'admin.category-travel-address.edit',
            'admin.category-travel-address.delete',
            'admin.category-travel-address.bulk-delete',
        ]);
