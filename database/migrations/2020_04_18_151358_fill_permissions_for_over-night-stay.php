...
class FillPermissionsForOverNightStay extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForOverNightStay constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.over-night-stay',
            'admin.over-night-stay.index',
            'admin.over-night-stay.create',
            'admin.over-night-stay.show',
            'admin.over-night-stay.edit',
            'admin.over-night-stay.delete',
            'admin.over-night-stay.bulk-delete',
        ]);
