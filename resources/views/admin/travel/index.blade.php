                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                           href="{{ url('admin/travels/create') }}" role="button"><i
                                class="fa fa-plus"></i>&nbsp; {{ trans('admin.travel.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                                ...
                                <div class="row justify-content-md-between">
                                    <div class="col col-lg-7 col-xl-5 form-group">
                                        ...
                                        <span class="input-group-append">
                                            ...
                                            <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                                               href="{{ url('admin/travels/showModearation?showModeration=1') }}" role="button">
                                                {{ trans('admin.adminFilter.showNonModeration') }}</a>
                            ...
                            <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                <td class="bg-bulk-info d-table-cell text-center" colspan="9">
                                            <span class="align-middle font-weight-light text-dark">{{ trans('brackets/admin-ui::admin.listing.selected_items') }} @{{ clickedBulkItemsCount }}.  <a
                                                    ...
                                                    @click="onBulkItemsClickedAll('/admin/travels')"
                                    ...
                                    <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                        @click="bulkDelete('/admin/travels/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                        ...
                        <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/travels/create') }}"
                               role="button"><i
                                    class="fa fa-plus"></i>&nbsp; {{ trans('admin.travel.actions.create') }}</a>
                        </div>
                    </div>
