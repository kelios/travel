                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'name'">{{ trans('admin.article.columns.name') }}</th>
                                        <th is='sortable' :column="'article_type_id'">{{ trans('admin.article.columns.article_type_id') }}</th>
                                        <th is='sortable' :column="'publish'">{{ trans('admin.article.columns.publish') }}</th>
