...
<style>
    .section--demo-1 .agile__actions {
        margin-top: 20px
    }

    .section--demo-1 .agile__nav-button {
    ...
    .section--demo-1 .agile__nav-button:hover {
        color: #888
    }

    .section--demo-1 .agile__dot {
        margin: 0 10px
    }

    .section--demo-1 .agile__dot button {
    ...
    .section--demo-1 .agile__dot--current button, .section--demo-1 .agile__dot:hover button {
        background-color: #888
    }

    .section--demo-1 .slide {
        height: 400px;
    ...
    .section--demo-1 .slide h3 {
        font-size: 32px;
        font-weight: 300
    }

    .section--demo-1 .slide--1 {
        background-color: #f1c40f
    }

    .section--demo-1 .slide--2 {
        background-color: #e67e22
    }

    .section--demo-1 .slide--3 {
        background-color: #e74c3c
    }

    .section--demo-1 .slide--4 {
        background-color: #9b59b6
    }

    .section--demo-1 .slide--5 {
        background-color: #3498db
    }

    .section--demo-1 .slide--6 {
    ...
    .section--demo-2 .agile__dot--current button, .section--demo-2 .agile__dot:hover button {
    ...
    .section--demo-3 .agile__dot {
        margin: 5px 0
    }

    .section--demo-3 .agile__dot button {
        background-color: transparent;
        border: 1px solid #fff;
        cursor: pointer;
        display: block;
    ...
    .section--demo-3 .agile__dot--current button, .section--demo-3 .agile__dot:hover button {
        background-color: #fff
    }

    .section--demo-3 .slide {
        display: block;
        -o-object-fit: cover;
        object-fit: cover;
        width: 100%
    ...
    * {
    ...
    .button:active, .button:focus, a:active, a:focus, button:active, button:focus, input:active, input:focus, textarea:active, textarea:focus {
        outline: none
    }
    ...
    .section--header .section__title {
        border-bottom: 1px solid rgba(127, 140, 141, .2);
        margin-bottom: 20px;
        padding-bottom: 20px
    }
    ...
    .copyright {
        border-top: 1px solid rgba(127, 140, 141, .2);
        margin-bottom: 5px;
        padding-top: 30px
    }
    ...
    .codepen span:first-child {
        font-size: 10px;
        letter-spacing: 2px
    }

    .codepen span:last-child {
        font-size: 18px;
        font-weight: 600;
        letter-spacing: 2px
    }

    .section--demo-2 .container-fluid {
        padding: 0
    }
    ...
    .agile__slides { /* -webkit-box-align:center; */
